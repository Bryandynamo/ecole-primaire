...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(public_path('css/bulletin_officiel.css')); ?>">
    <style>
    ...
    <div class="layout-container">
        ...
        <div class="notes-section">
            <div class="header-info" style="margin-bottom: 1mm;">
                ...
                <strong>Trimestre:</strong> <?php echo e($trimestre ?? ''); ?>
            ...
            <table class="table-bulletin" style="width:100%; border-collapse:collapse;">
                <tr>
                    ...
                    <th colspan="<?php echo e(count($uaNums)*2); ?>" class="center border b">TRIMESTRE<br>Notes par UA</th>
                </tr>
                <tr>
                ...
                <?php $__currentLoopData = $sc['mods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="border small"><?php echo e($mod['mod']); ?></td>
                                <?php $__currentLoopData = $uaNums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ua): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="border center"><?php echo e($b['notes'][$mod['scid']][$mod['modid']][$ua] ?? ''); ?></td>
                                    <td class="border center"><?php echo e(cote($b['notes'][$mod['scid']][$mod['modid']][$ua] ?? '')); ?></td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="table-bulletin" style="width:100%; font-size:6pt; border-collapse:collapse;">
                <tr>
                    <td colspan="4" class="b" style="padding:0.5px 1px; background:#e1f7d5; text-align:center; font-size:7pt;">
                        ...
                        <?php else: ?>
                            Moyenne trimestrielle : <span style="font-weight:bold; font-size:8pt;"><?php echo e($b['moyenne'] ?? ''); ?></span> / 20 <span style="font-weight:bold; color:#007bff;">(<?php echo e(rangOrdinal($b['rangTrimestre'] ?? 0)); ?>)</span>
                        <?php endif; ?>
                    </td>
                </tr>
                <tr>
...
<?php /**PATH C:\Users\User Dell\3D Objects\bulletin\webapp-laravel\resources\views/bulletins/modele_officiel.blade.php ENDPATH**/ ?>