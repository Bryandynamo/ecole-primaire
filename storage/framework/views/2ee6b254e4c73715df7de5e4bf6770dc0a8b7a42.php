...
<div class="wrap">
    <div class="card">
        ...
        <a href="<?php echo e(route('users.create')); ?>" class="btn" style="display:inline-block; text-align:center; background:#059669">Créer un compte</a>

        <div class="footer">© <?php echo e(date('Y')); ?> - Établissement</div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\User Dell\3D Objects\bulletin\webapp-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>